  ...
  <div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <div class="flex items-center justify-between mb-4">
      ...
      <button @click="isEditing = !isEditing" 
              :class="{'text-green-600 dark:text-green-400': isEditing, 'text-blue-600 dark:text-blue-500': !isEditing}" 
      ...
      <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
        <li v-for="(customer, index) in customers" :key="index" class="py-3 sm:py-4">
          <div class="flex items-center">
            <button v-if="isEditing" @click="deleteCustomer(index)" class="text-red-500 hover:text-red-700 mr-4">Delete</button>
